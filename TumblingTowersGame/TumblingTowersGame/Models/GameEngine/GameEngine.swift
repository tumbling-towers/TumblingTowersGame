...
class GameEngine {
    ...
    init(levelDimensions: CGRect) {
        ...
        self.statsTrackingSystem = StatsTrackingSystem(eventManager: eventManager)
        self.achievementSystem = AchievementSystem(eventManager: eventManager, dataSource: statsTrackingSystem)
