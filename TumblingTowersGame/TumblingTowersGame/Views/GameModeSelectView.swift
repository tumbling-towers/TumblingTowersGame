        ...
        ZStack {
            ...
            VStack {
                ...
                VStack {
                    ...
                    if let playersMode = mainGameMgr.playersMode {
                        HStack {
    ...
    private func drawGameModeOption(gameMode: Constants.GameModeTypes, playerMode: PlayersMode, name: String, fontSize: CGFloat, red: Double, green: Double, blue: Double) -> AnyView {
        AnyView(
            Button {
                ...
                } else if playerMode == .threeplayer {
                    currGameScreen = .threeplayerGameplay
                } else if playerMode == .fourplayer {
                    currGameScreen = .fourplayerGameplay
                }
            } label: {
                Text(name)
